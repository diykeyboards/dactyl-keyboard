...
class VelvetCluster(DefaultCluster):
    velvet_Usize = 1.6
    ...
    def get_config(self):
        with open(os.path.join(r"..", "src", "clusters", "json", "VELVET.json"), mode='r') as fid:
            data = json.load(fid)
    ...
    def thumb(self, side="right"):
        ...
        shape = union([shape, self.thumb_fx_layout(adjustable_plate(self.velvet_Usize))])
    ...
    def thumb_post_tr(self):
        ...
        return translate(web_post(),
                         [(mount_width / 2) - post_adj, ((mount_height/2) + adjustable_plate_size(self.velvet_Usize)) - post_adj, 0]
                         )
 ...
 #                          [
  ...
  #                     )])
    ...
    def screw_positions(self):
        ...
        position[1] = position[1] - .4 * (self.velvet_Usize - 1) * sa_length
        position[2] = 0
